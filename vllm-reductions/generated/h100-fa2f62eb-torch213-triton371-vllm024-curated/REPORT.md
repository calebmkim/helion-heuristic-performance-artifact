...
|---|---:|---:|---:|---:|---:|
| `dynamic_per_token_scaled_fp8_quant` | 24/24 | 0.324x | 1.111x | 1.122x | 1.000x |
| `fused_qk_norm_rope` | 21/21 | 1.001x | 1.038x | 1.074x | 1.000x |
| `per_token_group_fp8_quant` | 24/24 | 1.169x | 1.197x | 1.261x | 1.000x |
| `rms_norm_dynamic_per_token_quant` | 36/36 | 0.187x | 1.284x | 1.304x | 1.000x |
| `rms_norm_per_block_quant` | 24/24 | 0.722x | 1.449x | 1.502x | 1.000x |
| `silu_and_mul_per_block_quant` | 24/24 | 1.365x | 1.565x | 1.647x | 1.000x |
| **Overall** | **153/153** | **0.578x** | **1.268x** | **1.308x** | **1.000x** |
